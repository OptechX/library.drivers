...
output_csv = os.path.join(os.path.dirname(os.path.realpath(__file__)),'output/lenovo-thinkpad.csv')
...
thinkpad_driver_pack = data_table[3]



for machine in thinkpad_driver_pack.find_all('tbody'):
