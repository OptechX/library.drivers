...
win11_latitude_csv = os.path.join(os.path.dirname(os.path.realpath(__file__)),'output/win11_dell_latitude.csv')
win11_latitude_csv2 = os.path.join(os.path.dirname(os.path.realpath(__file__)),'output/win11_dell_latitude2.csv')
