...
win10_xps_csv = os.path.join(os.path.dirname(os.path.realpath(__file__)),'output/win10_dell_xps.csv')
win10_xps_csv2 = os.path.join(os.path.dirname(os.path.realpath(__file__)),'output/win10_dell_xps2.csv')
