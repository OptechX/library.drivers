$srcFile = "./app/data/Lenovo/lenovo-thinkcentre.csv"
...
$win10FileContent = "./app/data/Lenovo/lenovo-thinkcentre-win10.csv"
$win11FileContent = "./app/data/Lenovo/lenovo-thinkcentre-win11.csv"
