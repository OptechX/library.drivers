$srcFile = "./app/data/Lenovo/lenovo-thinkstation.csv"
...
$win10FileContent = "./app/data/Lenovo/lenovo-thinkstation-win10.csv"
$win11FileContent = "./app/data/Lenovo/lenovo-thinkstation-win11.csv"
