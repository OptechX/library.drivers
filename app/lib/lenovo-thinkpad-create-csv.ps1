$srcFile = "./app/data/Lenovo/lenovo-thinkpad.csv"
...
$win10FileContent = "./app/data/Lenovo/lenovo-thinkpad-win10.csv"
$win11FileContent = "./app/data/Lenovo/lenovo-thinkpad-win11.csv"
