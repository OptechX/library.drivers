...
win11_optiplex_csv = os.path.join(os.path.dirname(os.path.realpath(__file__)),'output/win11-dell-optiplex.csv')
win11_optiplex_csv2 = os.path.join(os.path.dirname(os.path.realpath(__file__)),'output/win11-dell-optiplex2.csv')
