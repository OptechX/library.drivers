...
win10_optiplex_csv = os.path.join(os.path.dirname(os.path.realpath(__file__)),'output/win10-dell-optiplex.csv')
win10_optiplex_csv2 = os.path.join(os.path.dirname(os.path.realpath(__file__)),'output/win10-dell-optiplex2.csv')
