...
# CSV OUTPUT SETUP
model = "Surface 3 (4G LTE) in North America (non-AT&T)"
output_text = "Microsoft,Surface 3," + model + ","
win10 = 'False,'
win11 = 'False'
...
# GET DOWNLOAD LINK
driver.get('https://www.microsoft.com/download/details.aspx?id=49037')
