...
[System.String]$MANUFACTURER = "Microsoft"
<# Note: Microsoft DOES NOT SUPPORT x86 ANYMORE #>

# [System.String]$PC_MAKE = ""
[System.String[]]$CsvFiles = (Get-ChildItem -Path $PSScriptRoot -Filter *.csv -Recurse | Select-Object -ExpandProperty FullName)
